...
func (c *dhcpConn) broadcast(respData []byte, peer *net.UDPAddr) (n int, err error) {
	...
	//
	// See https://github.com/andrzejlapinski/AdGuardHome/issues/3480 and
	// https://github.com/andrzejlapinski/AdGuardHome/issues/3366.
	//
	// See also https://github.com/andrzejlapinski/AdGuardHome/issues/3539.
